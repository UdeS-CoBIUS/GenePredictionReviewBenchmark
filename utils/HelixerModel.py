...
class HelixerModel(ABC):
    ...
    def set_optimizer(self):
        if self.optimizer.lower() == 'adam':
            self.optimizer = Adam(learning_rate=self.learning_rate, clipnorm=self.clip_norm)
        elif self.optimizer.lower() == 'adamw':
            self.optimizer = AdamW(learning_rate=self.learning_rate, clipnorm=self.clip_norm, weight_decay=self.weight_decay)
